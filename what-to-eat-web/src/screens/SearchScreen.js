...
const SearchScreen = () => {
    ...
    const { ingredientsList, setIngredientsList, excludedIngredients, setExcludedIngredients, selectedMax, setSelectedMax, includedInputRef, excludedInputRef, searchInfo, searchNow, mealType, setMealType } = (0, useIngredients_1.useIngredients)();
    // Meals
    ...
    const MaxIngredientComponent = (props) => {
        ...
        return ((0, jsx_runtime_1.jsx)("a", { onClick: handleClick, className: `w-9 h-9 flex justify-center items-center rounded-xl p-2 font-medium text-2xl ${isSelected ? 'bg-blue-500' : 'bg-green-500'} text-white cursor-pointer`, children: props.item }));
    };
    // Meal type button component
    const MealTypeComponent = (props) => {
        const handleClick = () => {
            setMealType(meals.findIndex(x => x === props.item));
        };
        const selected = mealType === meals.findIndex(x => x === props.item);
        return ((0, jsx_runtime_1.jsx)("a", { onClick: handleClick, className: `h-9 m-1 flex justify-center items-center rounded-xl px-3 py-2 font-medium ${selected ? 'bg-blue-500' : 'bg-green-500'} text-white cursor-pointer`, children: props.item }));
    };
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col my-3 mx-5 h-full relative", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col w-full my-5", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-row justify-between items-center", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-3xl font-extrabold title-text", children: "Ingredients" }), (0, jsx_runtime_1.jsx)("span", { className: "flex justify-center items-center text-xl font-bold rounded-xl ml-5 p-4 w-7 h-7 bg-orange-400 text-white", children: ingredientsList.length })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-row items-center mt-2 -mx-1 flex-wrap relative", children: [ingredientsList.map((item, key) => {
                            ...
                            }), (0, jsx_runtime_1.jsxs)("form", { className: "relative flex justify-center", onSubmit: addIngredient, children: [includedInputActive && (0, jsx_runtime_1.jsx)("input", { type: "text", className: "absolute top-[-45px] rounded-xl border-black border-2 shadow-md outline-none w-40 py-2 px-1", ref: includedInputRef }), (0, jsx_runtime_1.jsx)("a", { onClick: () => setIncludedInputActive(!includedInputActive), className: "bg-green-500 text-white m-1 px-3 py-2 rounded-2xl font-medium title-text cursor-pointer", children: "Add +" })] })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col w-full my-5", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-row justify-between items-center", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-3xl font-extrabold title-text", children: "Max Additional Ingredients" }), (0, jsx_runtime_1.jsx)("span", { className: "flex justify-center items-center text-xl font-bold rounded-xl ml-5 p-4 w-7 h-7 bg-orange-400 text-white", children: selectedMax })] }), (0, jsx_runtime_1.jsx)("div", { className: "flex flex-row items-center mt-4 space-x-3", children: [...Array(6)].map((_, index) => ((0, jsx_runtime_1.jsx)(MaxIngredientComponent, { item: index }, index))) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col w-full my-5", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-row justify-between items-center", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-3xl font-extrabold title-text", children: "Exclude Ingredients" }), (0, jsx_runtime_1.jsx)("span", { className: "flex justify-center items-center text-xl font-bold rounded-xl ml-5 p-4 w-7 h-7 bg-orange-400 text-white", children: excludedIngredients.length })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-row items-center mt-2 -mx-1 flex-wrap", children: [excludedIngredients.map((item, key) => {
                                return (0, jsx_runtime_1.jsx)(IngredientItem, { item: item, setArray: setExcludedIngredients, array: excludedIngredients }, key);
                            }), (0, jsx_runtime_1.jsxs)("form", { className: "relative flex justify-center", onSubmit: addExcludedIngredient, children: [excludedInputActive && (0, jsx_runtime_1.jsx)("input", { type: "text", className: "absolute top-[-45px] rounded-xl border-black border-2 shadow-md outline-none w-40 py-2 px-1", ref: excludedInputRef }), (0, jsx_runtime_1.jsx)("a", { onClick: () => setExcludedInputActive(!excludedInputActive), className: "bg-green-500 text-white m-1 px-3 py-2 rounded-2xl font-medium title-text cursor-pointer", children: "Add +" })] })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col w-full my-5", children: [(0, jsx_runtime_1.jsx)("div", { className: "flex flex-row justify-between items-center", children: (0, jsx_runtime_1.jsx)("h1", { className: "text-3xl font-extrabold title-text", children: "Meal Type" }) }), (0, jsx_runtime_1.jsx)("div", { className: "flex flex-row items-center mt-2 -mx-1 flex-wrap", children: meals.map((item, key) => {
                            return (0, jsx_runtime_1.jsx)(MealTypeComponent, { item: item }, key);
                        }) })] }), (0, jsx_runtime_1.jsxs)("button", { onClick: checkSearch, className: "absolute cursor-pointer flex flex-row justify-center items-center py-2 px-4 bg-black text-white text-2xl font-bold rounded-xl bottom-5 right-0 active:shadow-2xl shadow-md", children: ["Search", (0, jsx_runtime_1.jsx)("img", { src: exports_1.searchIcon, className: "h-6 ml-2", alt: "Search Icon" })] })] }));
};
